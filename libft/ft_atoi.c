...
/* В этой фнкции ожидает ощиченое от мусора число без знака
 * Возвращает 0 если переполнения нет, -1 если отрицательное переполнение
 * и 1 если положительное
 * Очищает переданный в нее указатель */
